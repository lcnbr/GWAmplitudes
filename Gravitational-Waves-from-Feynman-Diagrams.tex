...
perturbative \gls{qft} one introduces the graviton. Disappointingly,
such a theory breaks down at high energies, and is un-renormalisable .
In fact the presence of black holes, that dominate the high energy
spectrum of \gls{gr}, is a testament to that fact
...
Surprisingly, one can still use the powerful tools of one to tackle
problems in the other. Specifically, if one considers the classical
limit of \gls{qft}, one is able to extract perturbative gravitational
...
differential equations and more recently generalized unitarity, all
yielding efficient computations for scattering amplitudes, can all be
applied to \emph{classical} orbital dynamics in \gls{gr}. This is
