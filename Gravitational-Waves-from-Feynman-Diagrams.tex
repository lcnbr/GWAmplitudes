...
\(t\to\pm\infty\)\sidenote{\footnotesize See
...
space wavefunction will be largest when the stationary phase point is
...
\(\vInt\) as the following matrix elements \sidenote{\footnotesize NB: the notation is
  ...
  ~{[}\protect\hyperlink{ref-Bern:2021xze}{49}{]} paper}
...
particles. \sidenote{\footnotesize The number of extracted couplings being twice that.}
