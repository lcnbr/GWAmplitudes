...
webpage at https://lcnhb.github.io/GWAmplitudes, or downloaded as a PDF
file. All code used for the thesis is provided in the GitHub repository
https://github.com/lcnhb/GWAmplitudes.
...
try to write an interpret one in the language of the other, but in
either case difficulties arise. Writing \gls{gr} in terms of
perturbative \gls{qft} one introduces the graviton. However it turns out
that such a theory breaks down at high energies, and is
...
not quantize gravity itself, and therefore does not really adress the
problem. Background independent theories such as loop quantum gravity
does not as of yet have semiclassical limit collapsoing to \gls{gr}
String theory, on the other hand, introduces spurious dimensions that
need to be compactified, which leads to uncountably many different
solutions. In short, there is no satisfactory theory of that combines
\gls{gr} and \gls{qft} in a consistent way.

Regardless of this fact however, one can still use the powerful tools of
ine to tackle problems in the other. Specifically, if one considers the
...
more recently generalised unitarity, can all be applied to
...
\gls{eob} , in chapter 4 we look at the state of the art formalsims that
...
presented in ~{[}\protect\hyperlink{ref-Pretorius:2005gq}{14}{]}}
...
~{[}\protect\hyperlink{ref-Bern:2019crd}{47}{]} up to \gls{pm} using
...
i.e.~at asymptotic times \(t\to\pm\infty\)\sidenote{\footnotesize see
  ~{[}\protect\hyperlink{ref-Coleman:2018a}{43}{]} or
  ~{[}\protect\hyperlink{ref-Collins:2019ozc}{45}{]} for a more in depth
...
in the ~{[}\protect\hyperlink{ref-Bern:2021xze}{41}{]}
