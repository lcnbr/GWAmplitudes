...
First let us look at where and how gravitional waves are generated. We will look at how (?:gr)  predicts that graviational waves exist, and what conditions have to be met for them to become observable. We will also look at how we can detect them, and what we can learn from them.
...
Thus any object that is modifying its shape is a source of gravitional waves. All orbiting systems therefore are sources of (?s:gw) . However as said just above, only very important 'changes in shape' have a chance to be detectable. These phenomena are what we will explore next. 
