...
Thus, if we consider (?s:bh)  separated by ten times their Schwarzschild radius, observed at cosmological distances $\sim 100 \;\mathrm{Mpc}$, we obtain the values for the scales characterising the binary system:
