...
CF inv;
  *--#[d1l1:
L [d1l1|o.i.2.2|o.i|] = 1*i_* prop(-1,0,q1)*d_(nu1,nu2)*i_* prop(-1,0,q2)*d_(nu3,nu4);
...
*--#[d2l1:
L [d2l1|o.2.3|i.3|o.i|] = 1*i_* prop(-1,1,q1)*i_* prop(-1,0,q2)*d_(nu3,nu4)*i_* prop(-1,0,q3)*d_(nu5,nu6)*i_*e*qch1*(q1(nu3)-p4(nu3))*i_*e*qch1*(p3(nu5)-q1(nu5));
#procedure momentumRouting
Id q2 = p3 + -p4 + -q3;
Id p1 = p2 + p4 + -p3;
Id q1 = p3 + -q3;
...
*--#[d3l1:
L [d3l1|o.2.3|i.3|o.i|] = 1*i_* prop(-1,2,q1)*i_* prop(-1,0,q2)*d_(nu3,nu4)*i_* prop(-1,0,q3)*d_(nu5,nu6)*i_*e*qch2*(q1(nu3)-p2(nu3))*i_*e*qch2*(p1(nu5)-q1(nu5));
#procedure momentumRouting
Id q2 = p4 + -p3 + -q3;
Id p1 = p2 + p4 + -p3;
Id q1 = p2 + p4 + -p3 + -q3;
...
*--#[d4l1:
L [d4l1|o.i.2|o.3.3|i|] = 1*i_* prop(-1,0,q1)*d_(nu1,nu2)*i_* prop(-1,2,q2)*i_* prop(-1,0,q3)*d_(nu5,nu6)*i_*e*qch1*(p3(nu1)-p4(nu1))*i_*e*qch2*(q2(nu5)-p2(nu5));
#procedure momentumRouting
Id q2 = p2 + q3;
Id p1 = p2 + p4 + -p3;
Id q1 = p3 + -p4;
...
*--#[d5l1:
L [d5l1|i.3.3|o.i.3|o|] = 1*i_* prop(-1,0,q1)*d_(nu1,nu2)*i_* prop(-1,2,q2)*i_* prop(-1,0,q3)*d_(nu5,nu6)*i_*e*qch1*(p3(nu1)-p4(nu1))*i_*e*qch2*(p1(nu5)-q2(nu5));
#procedure momentumRouting
Id q2 = p2 + p4 + -p3 + -q3;
Id p1 = p2 + p4 + -p3;
Id q1 = p3 + -p4;
...
*--#[d6l1:
L [d6l1|o.i.2|o.3.3|i|] = 1*i_* prop(-1,0,q1)*d_(nu1,nu2)*i_* prop(-1,1,q2)*i_* prop(-1,0,q3)*d_(nu5,nu6)*i_*e*qch2*(p1(nu1)-p2(nu1))*i_*e*qch1*(q2(nu5)-p4(nu5));
#procedure momentumRouting
Id q2 = p4 + q3;
Id p1 = p2 + p4 + -p3;
Id q1 = p4 + -p3;
...
*--#[d7l1:
L [d7l1|i.3.3|o.i.3|o|] = 1*i_* prop(-1,0,q1)*d_(nu1,nu2)*i_* prop(-1,1,q2)*i_* prop(-1,0,q3)*d_(nu5,nu6)*i_*e*qch2*(p1(nu1)-p2(nu1))*i_*e*qch1*(p3(nu5)-q2(nu5));
#procedure momentumRouting
Id q2 = p3 + -q3;
Id p1 = p2 + p4 + -p3;
Id q1 = p4 + -p3;
