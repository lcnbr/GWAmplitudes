...
\let\@Exp\
\renewcommand{\Exp}[2][\pa]{\texttip{\@Exp[#1]{#2}}{exponential function}} 
...
<!-- Vectors -->
\let\@tv\tv
\renewcommand{\tv}[1]{\texttip{\@tv{#1}}{3-vector}}
...
<!-- Physics Units -->
\let\@mass\mass
\renewcommand{\mass}[1]{\texttip{#1}{mass}}
...
\let\@SRDA\SRDA
\renewcommand{\SRDA}{\mathtip{\@SRDA}{\invmink \partialder_\mu\partialder_\nu}}
...
\renewcommand{\obschange}[3][\obs{O}]{\mathtip{\@obschange[#1]{#2}{#3}}{\text{Observable change: }\@obschange[#1]{#2}{#3}}}