...
\let\exp\oldexp
\renewcommand{\exp}[1]{\texttip{\mathrm{e}^{#1}}{exponential function}}
...
\newcommand{\@normalized}[1]{\tilde{#1}}
\newcommand{\normalized}[2][]{\mathtip{\@normalized{#2}}{\text{Normalized } #1 =#2(2\pi)^{#1}}}


\newcommand{\dn}[2][]{\,\mathtip{\@normalized{\differential}^{#1}#2}{\@normalized{\differential}^{#1}#2=\frac{\dd[#1]{#2}}{(2\pi)^{#1}}}\,}
...
\newcommand{\@ndeltafn}[2][]{\@normalized{\delta}^{(#1)}\left(#2\right)}
...
\newcommand{\posendelta}[2][-m^2]{\mathtip{\@posdelta[#1]{#2}}{\text{Positive energy delta function: }\@posdelta[#1]{#2}}=\deltafn{#2^2 #1}\thetafn{#2^0}}

\newcommand{\@nposendelta}[2][-m^2]{\@ndeltafn[+]{#2^2#1}}
...
\let\bra\oldbra
\renewcommand{\bra}[2][]{\mathtip{\sideset{_{\text{#1}}}{}\langle #2 \vert}{\text{Quantum state bra, dual to ket, a linear form on the Hilbert space: }#2: \mathcal{H} \rightarrow \mathbb{C}}}

\let\ket\oldket
\renewcommand{\ket}[2][]{\mathtip{\sideset{}{_{\text{#1}}}{\vert #2 \rangle}}{\text{Quantum state ket, a vector of the Hilbert space: }#2\in\mathcal{H}}}
