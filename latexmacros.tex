...
\let\oldexp\exp
\newcommand{\exp}[1]{\hrm{e}^{#1}}

\newcommand{\greens}[2][ret]{{\mathcal{G}_{\mathrm{#1}}\left(#2\right)}{#1 Green's function}}
\newcommand{\thetafn}[2][]{{\Theta^{(#1)}\left(#2\right)}{Heaviside step function}}
\newcommand{\deltafn}[2][]{{\delta^{(#1)}\left(#2\right)}{Dirac delta function}}
...
\newcommand{\Smat}{{S}{S-matrix}}
\newcommand{\Tmat}{{T}{Transfer-matrix}}
...
\newcommand{\cov}[2][\mu]{#2_{#1}}
\newcommand{\con}[2][\mu]{#2^{#1}}
...
\newcommand{\met   }[1][\mu\nu]{\cov[#1]{\metricTensor}}
\newcommand{\invmet}[1][\mu\nu]{\con[#1]{\metricTensor}}

\newcommand{\minkoskiMetric}{\eta}
\newcommand{\mink   }[1][\mu\nu]{\cov[#1]{\minkoskiMetric}}
\newcommand{\invmink}[1][\mu\nu]{\con[#1]{\minkoskiMetric}}
...
\newcommand{\weakTTmet      }[1][ij]{\cov[#1]{\weakTTTensor}}
\newcommand{\invweakTTmet   }[1][ij]{\con[#1]\weakTTTensor}} 
